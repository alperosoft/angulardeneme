...
@Component({
  selector: 'app-rapor', // HTML şablonunda kullanılacak etiket adı
  standalone: true,
  templateUrl: './rapor.component.html', // Component'in HTML şablonunun belirlenmesi
  styleUrls: ['./rapor.component.scss'], // Component'e ait CSS stil dosyalarının belirlenmesi
...
export class RaporChartComponent implements OnInit {
